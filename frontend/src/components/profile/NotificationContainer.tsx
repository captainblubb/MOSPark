...
> {
    constructor(props: { currentUserId: number }) {
        super(props);

        NotificationContainer.fetchNotifications = NotificationContainer.fetchNotifications.bind(
            this
        );
        this.state = {
            notifications: NotificationContainer.fetchNotifications()
        };
